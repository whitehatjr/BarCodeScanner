...
export declare function ensureBuildGradleContainsConfigurationScript(projectRoot: string, config: Pick<ExpoConfigUpdates, 'nodeModulesPath'>, buildGradleContents: string): string;
...
export declare function isBuildGradleConfigured(projectRoot: string, config: Pick<ExpoConfigUpdates, 'nodeModulesPath'>, buildGradleContents: string): boolean;
