...
function ensureBuildGradleContainsConfigurationScript(projectRoot, config, buildGradleContents) {
...
function formatApplyLineForBuildGradle(projectRoot, config) {
    const updatesGradleScriptPath = modules_1.projectHasModule(CREATE_MANIFEST_ANDROID_PATH, projectRoot, config);
...
function isBuildGradleConfigured(projectRoot, config, buildGradleContents) {
